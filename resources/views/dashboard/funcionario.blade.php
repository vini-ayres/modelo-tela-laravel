...
@section('links-sidebar')
    ...
    <a href="/dashboard-funcionario/lista" onclick="changeTab(this)">Lista de ordens de serviço</a>
    <a href="/dashboard-funcionario/status" onclick="changeTab(this)">Status das ordens de serviço</a>
    <a href="/dashboard-funcionario/gerenciamento" onclick="changeTab(this)">Gerenciamento de usuários</a>
